...
def get_instructions():
    print(f'COMMANDS:'
          ...
          f'{out_azure("arguments")}\033[0m: name of section'
          f'\n {out_azure("delete expense")}\033[0m --- delete expense with comment and date, '
          f'{out_azure("arguments")}\033[0m: name of section, comment to expense, date of expense'
          f'\n {out_azure("add expense")}\033[0m --- add new expense in section, '
          f' {out_azure("arguments")}\033[0m: name of section, price of expense, comment to expense'
